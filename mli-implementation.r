...
genePredictorRange  <- 1:40 #Selects Genes Labeled X1 - X10 in Training Data Set - 100 genes, Trying not to Get Too Crazy
...
#         print(paste("SVM Model - Drug: ", k, "- Prediction Error:", decimals(abs(error), 2), "%"))
...
# print(paste("SVM Model - Drug: Linear - Prediction Error:", decimals(abs(trainLinearError), 2), "%"))
# 
...
# # print(paste("Testing Data SVM Linear - Prediction Error:", decimals(abs(testLinearError), 2), "%"))
# 
...
# print(paste("SVM Model - Drug: Polynomial - Prediction Error:", decimals(abs(trainPolyError), 2), "%"))
# 
...
# # print(paste("Testing Data SVM Polynomial - Prediction Error:", decimals(abs(testPolyError), 2), "%"))
# 
...
# print(paste("SVM Model - Drug: Radial - Prediction Error:", decimals(abs(trainRadialError), 2), "%"))
...
# print(paste("Testing Data SVM Radial - Prediction Error:", decimals(abs(testRadialError), 2), "%"))
...
# print(paste("SVM Model - Drug: Sigmoid - Prediction Error:", decimals(abs(trainSigmoidError), 2), "%"))
...
# print(paste("Testing Data SVM Sigmoid - Prediction Error:", decimals(abs(testSigmoidError), 2), "%"))
