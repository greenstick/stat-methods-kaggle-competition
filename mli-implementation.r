...
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error1), 2), "%"))
...
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error2), 2), "%"))
...
error3      <- sum(trainingData$Carboplatin - (as.numeric(predict3) - 1)) / length(predict3) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error3), 2), "%"))
...
error4      <- sum(trainingData$Carboplatin - (as.numeric(predict4) - 1)) / length(predict4) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error4), 2), "%"))
...
error5      <- sum(trainingData$Carboplatin - (as.numeric(predict5) - 1)) / length(predict5) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error5), 2), "%"))
...
error6      <- sum(trainingData$Carboplatin - (as.numeric(predict6) - 1)) / length(predict6) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error6), 2), "%"))
...
error7      <- sum(trainingData$Carboplatin - (as.numeric(predict7) - 1)) / length(predict7) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error7), 2), "%"))
...
error8      <- sum(trainingData$Carboplatin - (as.numeric(predict8) - 1)) / length(predict8) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error8), 2), "%"))
...
error9      <- sum(trainingData$Carboplatin - (as.numeric(predict9) - 1)) / length(predict9) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error9), 2), "%"))
...
error10      <- sum(trainingData$Carboplatin - (as.numeric(predict10) - 1)) / length(predict10) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error10), 2), "%"))
...
error11      <- sum(trainingData$Carboplatin - (as.numeric(predict11) - 1)) / length(predict11) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error11), 2), "%"))
...
error12      <- sum(trainingData$Carboplatin - (as.numeric(predict12) - 1)) / length(predict12) * 100
print(paste("Training Data SVM Carboplatin Kernel Prediction Error:", decimals(abs(error12), 2), "%"))
